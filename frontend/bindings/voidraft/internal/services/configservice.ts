 ...
 * Watch 注册配置变更监听器
 */
export function Watch(path: string, callback: $models.ObserverCallback): $CancellablePromise<$models.CancelFunc> {
 ...
 */
export function WatchWithContext(path: string, callback: $models.ObserverCallback): $CancellablePromise<void> {
